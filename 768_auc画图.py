...
dataset1 = pd.read_csv(r'C:\users\14903\Desktop\data\768\原始数据集\diabetes.csv')
...
# 导入数据，路径中要使用\\或者/或者在路径前面加r
dataset2 = pd.read_csv(r'C:\users\14903\Desktop\data\768\最大相关最小冗余数据集\fz1.csv')
...
# 导入数据，路径中要使用\\或者/或者在路径前面加r
dataset3 = pd.read_csv(r'C:\users\14903\Desktop\data\768\关键特征数据集\fz3.csv')
