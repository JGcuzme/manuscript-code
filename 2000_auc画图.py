...
dataset1 = pd.read_csv(r'C:\users\14903\Desktop\data\2000\原始数据集\diabetes.csv')
...
dataset2 = pd.read_csv(r'C:\users\14903\Desktop\data\2000\最大相关最小冗余数据集\fz1.csv')
...
dataset3 = pd.read_csv(r'C:\users\14903\Desktop\data\2000\关键特征数据集\fz3.csv')
