...
dataset = pd.read_csv(r'C:\users\14903\Desktop\submitting\data\feature set 8.csv')

# 将字符串类型的分类变量重新编码
label = LabelEncoder()
dataset["PregnanciesGlucose00"] = label.fit_transform(dataset["PregnanciesGlucose00"])
dataset["SkinThicknessDiabetesPedigreeFunction00"] = label.fit_transform(dataset["SkinThicknessDiabetesPedigreeFunction00"])
...
dataset["DiabetesPedigreeFunctionPregnancies11"] = label.fit_transform(dataset["DiabetesPedigreeFunctionPregnancies11"])
